...
public class SeoulTempView implements ActionListener, FocusListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(obj == jtf_date) {
            ...
            jp_north.remove(jcb_mm);			//기존에 있던 연도 갑을 버리고 달의 데이터를 받겠다.
            jcb_mm = null;						//candidate상태 - 이전에 주소를 버리고
            jcb_mm = new JComboBox(months); 	//새로운 주소를 받음
            jcb_mm.addActionListener(this);		//다시 이벤트를 다시 발생
